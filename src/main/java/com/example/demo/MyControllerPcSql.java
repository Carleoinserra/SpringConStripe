...
//</form>
    ...
    @PostMapping("/Recap")
   public String getResoconto(Model model, @RequestParam("mail") String mail, @RequestParam("token") String token) throws MessagingException     {
    	...
    	emailService.sendEmailWithImage(mail, "mail dallo stor pc", recap, url);
		  ...
		  model.addAttribute("response", risult);
